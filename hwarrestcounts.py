...
#Almost done. Only thing to do now is to ensure that the datecounts columns is returned in chronological order.
...
def hwarrests(csv):
    ...
    dateray = np.array(hdf['Arrest Date'])  #Creates array of arrest dates in hdf
